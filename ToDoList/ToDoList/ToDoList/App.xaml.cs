	...
	public partial class App : Application
    {
        ...
        public static TodoItemDatabase Database
        {
            get
            {
                if (_database == null)
                {
                    _database = new TodoItemDatabase(DependencyService.Get<IFileHelper>().GetLocalFilePath("TodoSQLite6.db3"));
                }
                return _database;
            }
        }
        ...
        public static DatabaseAccess DatabaseAccess
        {
            get
            {
                if (_databaseAccess == null)
                {
                    ...
                    _databaseAccess = new DatabaseAccess(filehelperInstance.GetLocalFilePath("TodoSQLite6.db3"));
                }
